...
- If you don't want to touch the core file (which is not a big deal) you can use [`Customize UI`](https://marketplace.visualstudio.com/items?itemName=iocave.customize-ui).
  - This method may/may not work as extensions can't be guaranteed to work always.
...
## Terminal
After hopping over number terminals I finally settled with [`Kitty 😻`](https://github.com/kovidgoyal/kitty). Config: `.dotfiles/.config/kitty`.
